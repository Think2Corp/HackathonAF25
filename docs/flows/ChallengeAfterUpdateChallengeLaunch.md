# ChallengeAfterUpdateChallengeLaunch

## Flow Diagram

![diagram](./ChallengeAfterUpdateChallengeLaunch-1.svg)
...
| Label                                        | ChallengeAfterUpdateChallengeLaunch                                                                                                                 |
| Status                                       | Active                                                                                                                                              |
| Does Require Record Changed To Meet Criteria | ✅                                                                                                                                                  |
| Description                                  | Copy of ChallengeAfterUpdateSlackChanLaunch for triggering when status moved to ToStart to Ongoing (not working with OR condition on the first one) |
| Environments                                 | Default                                                                                                                                             |
| Interview Label                              | ChallengeAfterUpdateChallengeLaunch {!$Flow.CurrentDateTime}                                                                                        |
...
### Create_Challenge_launch_message

| <!-- -->                   | <!-- -->                                              |
| :------------------------- | :---------------------------------------------------- |
| Type                       | Action Call                                           |
| Label                      | Create Challenge launch message                       |
| Action Type                | Generate Prompt Response                              |
| Action Name                | ChallengeLaunchMessage                                |
| Flow Transaction Model     | CurrentTransaction                                    |
| Name Segment               | ChallengeLaunchMessage                                |
| Offset                     | 0                                                     |
...
| Offset                      | 0                                                   |
| Store Output Automatically  | ✅                                                  |
| Input: Base Message (input) | Create_Challenge_launch_message.promptResponse      |
...
| Store Output Automatically | ✅                                                                  |
| Connector                  | [Create_Challenge_launch_message](#create_challenge_launch_message) |
