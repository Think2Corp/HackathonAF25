...
We extended Agentforce actions with a set of our own custom actions.

#### **Challenge Management**

- **GetChallenges.cls**

Retrieve and filter sales challenges based on status, date, manager, participant, and more.

- **helpers/ChallengeHelper.cls**

Helper logic for querying and filtering Challenge\_\_c records.
...
Retrieve users assigned to a specific role by name or ID.

- **GetUsersFromTextList.cls**

Extract user names or roles from a text list and return matching users.

- **GetUsersCustomPermissions.cls**

List custom permissions for users, filtered by names or IDs.

- **GetUsersInfoSlack.cls**

Provide user info (name, Salesforce ID, Slack ID) for Slack integration.

- **GetSubRoles.cls**

Retrieve sub-roles for a given role, supporting both ID and fuzzy name search.

- **helpers/UserHelper.cls**

Helper logic for user queries, role lookups, and permission extraction.

- **helpers/RoleHelper.cls**

Helper logic for role hierarchy queries.

#### **Sales and Task Management**

- **GetOpportunities.cls**

Query opportunities based on name, owner, close date, type, stage, and status.

- **helpers/OpportunityHelper.cls**

Helper logic for opportunity queries.

- **getTasks.cls**

Retrieve tasks filtered by subject, owner, status, priority, due date, and related records.

- **helpers/TaskHelper.cls**

Helper logic for task queries.

#### **Slack Integration**

- **actions/slack/GetMembersOfSlackChannel.cls**

Retrieve Slack user IDs for a given channel.

- **actions/slack/SendSlackToChannel.cls**

Send messages to Slack channels or direct messages.

- **actions/slack/ListSlackPublicChannels.cls**

List public Slack channels and their IDs.

- **helpers/SlackHelper.cls**

Helper logic for Slack API callouts, token management, and user mapping.

#### **Utility and Miscellaneous**

- **clean_collections.cls**

Utility to clean string collections (e.g., remove quotes) for Agentforce.

- **helpers/ActionHelper.cls**

Generic wrappers and helpers for invocable actions.

#### **Integration with Slack**

Agentforce leverages Slack integration to:

- Map Salesforce users to Slack users.  

- Animate sales teams by surfacing challenges, opportunities, and tasks directly in Slack.  

- Enable dynamic team management and gamification through real-time data and notifications.

#### **Usage**

All classes are designed as **Invocable Apex** for use by the Agentforce agent, supporting flexible, low-code automation and integration scenarios.
